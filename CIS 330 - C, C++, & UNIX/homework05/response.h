...
// Implementation of the HappyResponse class, inherits from the Response class
class HappyResponse : public Response{
  // OVerride respond method for happy response via polymorphism
  void respond(std::ostream& toWhere);

public:
  // Constructor that calls the parent constructor so that HappyResponse also
  // has 'keyword' and 'response'
