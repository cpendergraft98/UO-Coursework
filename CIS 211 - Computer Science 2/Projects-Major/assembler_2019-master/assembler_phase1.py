...
PATTERNS = [(ASM_FULL_PAT, AsmSrcKind.FULL),
            ...
            (ASM_COMMENT_PAT, AsmSrcKind.COMMENT), (ASM_MEMOP_PAT, AsmSrcKind.MEMOP), (ASM_JUMP_PAT, AsmSrcKind.JUMP)
            ]
    ...
    for lnum in range(len(lines)):
        ...
        try:
            ...
            if fields["kind"] == AsmSrcKind.FULL:
                ...
                log.debug("Passing thorugh DATA instruction")
                transformed.append(line)
...
def fix_optional_fields(fields):
