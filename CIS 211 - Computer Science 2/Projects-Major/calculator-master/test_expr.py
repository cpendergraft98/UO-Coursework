...
class TestMinus(unittest.TestCase):
    ...
    def test_minus_nested(self):
        exp = Minus(Minus(IntConst(5), IntConst(4)), IntConst(1))
        self.assertEqual(str(exp), "((5 - 4) - 1)")
        
    def test_subtraction_simple(self):
        exp = Minus(IntConst(5), IntConst(4))
        self.assertEqual(exp.eval(), IntConst(1))

    def test_subtraction_nested(self):
        exp = Minus(Minus(IntConst(5), IntConst(4)), IntConst(1))
...
class TestDivision(unittest.TestCase):
    ...
    def test_div_simple(self):
        exp = Div(IntConst(4), IntConst(2))
        self.assertEqual(exp.eval(), IntConst(2))
        
    def test_div_nested(self):
        exp = Div(Div(IntConst(4), IntConst(2)), IntConst(2))
        self.assertEqual(exp.eval(), IntConst(1))
