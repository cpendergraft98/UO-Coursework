echo "Creating Msg"
fsutil file createnew msg.txt 1000000
echo "Msg Created"
echo "Signing Message"
set "tstart = %time%"
echo %tstart%
openssl dgst -sha256 -sign privateKey2048.pem -out sig.bin msg.txt
set "tend = %time%"
echo %tend%
...
set "tstart = %time%"
echo %tstart%
openssl dgst -sha256 -verify publicKey2048.pem -signature sig.bin msg.txt
set "tend = %time%"
echo %tend%
